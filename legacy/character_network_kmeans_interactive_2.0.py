...
for file in csv_files:
    ...
    silhouette_scores.append({'File': file, 'Silhouette Score': silhouette_avg})
...
csv_output_path = os.path.join('output_kmeans', 'silhouette_scores.csv')
...
fig_bar.write_html(os.path.join('output_kmeans', 'silhouette_scores.html'))