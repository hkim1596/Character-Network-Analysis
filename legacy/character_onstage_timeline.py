...
def process_xml_to_heatmap(file_path):
    ...
    csv_output_directory = "output_timeline"
    if not os.path.exists(csv_output_directory):
        os.makedirs(csv_output_directory)

    csv_output_file_name = os.path.basename(file_path).replace(".xml", "_timeline.csv")
    ...
    # Save the heatmap to HTML file
    output_directory = "output_timeline"
    if not os.path.exists(output_directory):
        os.makedirs(output_directory)
    
    output_file_path = os.path.join(output_directory, os.path.basename(file_path).replace(".xml", ".html"))
